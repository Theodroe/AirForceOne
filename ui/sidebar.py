...
def _render_primary_menu() -> None:
    st.markdown('<div class="section-title" style="margin-bottom:.5rem;">주요 화면</div>', unsafe_allow_html=True)
...
def _render_account_dropdown(authenticated: bool) -> None:
    ...
    st.markdown('<div class="section-title" style="margin: .8rem 0 .45rem 0;">계정 메뉴</div>', unsafe_allow_html=True)
